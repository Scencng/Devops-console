...
func Register(engine *gin.Engine, connectionHandler *handler.ConnectionHandler, manager *service.ConnectionManager, metadataHandler *handler.MetadataHandler, dataHandler *handler.DataHandler, queryHandler *handler.QueryHandler, securityHandler *handler.SecurityHandler, backupHandler *handler.BackupHandler, schemaCompareHandler *handler.SchemaCompareHandler) {
